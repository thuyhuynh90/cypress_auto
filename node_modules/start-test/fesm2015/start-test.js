...
StartTestService.ɵprov = ɵɵdefineInjectable({ factory: function StartTestService_Factory() { return new StartTestService(); }, token: StartTestService, providedIn: "root" });
StartTestService.decorators = [
    { type: Injectable, args: [{
                providedIn: 'root'
            },] }
];
StartTestService.ctorParameters = () => [];
...
export { StartTestComponent, StartTestModule, StartTestService };
